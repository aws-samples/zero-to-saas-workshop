...
for TENANT_ADMIN in $TENANT_ADMIN_ARRAY; do
  ...
  echo ""
  echo "-------------------------------------------------"
  echo "Creating Product data for Basic tier User: $TENANT_ADMIN"
  echo "-------------------------------------------------"
  echo ""
  ...
  echo ""
  echo "-------------------------------------------------"
  echo "Creating Order data for Basic tier User: $TENANT_ADMIN"
  echo "-------------------------------------------------"
  echo ""
  ...
  echo ""
  echo "-------------------------------------------------"
  echo "Creating Promotion data for Basic tier User: $TENANT_ADMIN"
  echo "-------------------------------------------------"
  echo ""
  response=$(curl -s -w "\n%{http_code}" --request POST \
