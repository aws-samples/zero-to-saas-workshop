...
sys.path.append(
    os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'python_example_telemetry_api_extension')))
...
class TestTelemetryProcessing(unittest.TestCase):
    ...
    def test_get_function_message_record(self):
        ...
        self.assertEqual(function_message["resource"], "/products")
    ...
    def test_log_telemetry_stream(self):
        ...
        self.assertEqual(emf_platform_report["resource"], "/products")
